...
def main(image_path):
    ...
    mode_filtered_img = mode_filter(img, 3)
    ...
    images = [
        ...
        median_filtered, mode_filtered_img, max_filtered, min_filtered,
        sobel, prewitt, laplacian
    ]
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Perform histogram equalization and spatial filtering.')
